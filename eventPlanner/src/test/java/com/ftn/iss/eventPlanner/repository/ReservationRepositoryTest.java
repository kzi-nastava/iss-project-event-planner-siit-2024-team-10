...
public class ReservationRepositoryTest {
    ...
    @Test
    @DisplayName("Should return empty list for non-existing event ID")
    public void shouldReturnEmptyForNonExistingEventId() {
        Collection<Reservation> reservations = reservationRepository.findByEventId(0);
